...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_gpio_lite/altera_gpio_lite.sv" -work ddrix13 -cdslib ./cds_libs/ddrix13.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ddrix13.vhd"                                                                          
fi
