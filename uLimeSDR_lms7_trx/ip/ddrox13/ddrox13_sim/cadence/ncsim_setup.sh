...
# ACDS 15.1 193 win32 2016.05.17.17:19:14
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_gpio_lite/altera_gpio_lite.sv" -work ddrox13 -cdslib ./cds_libs/ddrox13.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ddrox13.vhd"                                                                          
fi
